            ...
            <div class="gpbox">
                ...
                <div class="items xiabox" :style="allping.length>=4?'width:80%;flex-wrap:wrap':''">
                    ...
                    <div class="canyu" v-for="(item,index) in allping" :key="index">
                        <img v-if="msgdata.resobj[index+1]" :src="msgdata.resobj[index+1].userimg?msgdata.resobj[index+1].userimg:(msgdata.resobj[index+1].userimg==''?'./img/man.jpg':'./img/hui.png')">
