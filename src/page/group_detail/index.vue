                ...
                <div class="g_xinqbox">
                    <div class="box_main items">
                        ...
                        <div class="pro_right">
                            <div class="pro_xian">
                                <div class="p1">
                                    <span style="margin-right: 8px;" :style="msgdata.buyonegetone || msgdata.headfree ? '' : 'padding: 0'" class="allhave"><span :style="msgdata.buyonegetone || msgdata.headfree ? 'margin-right: 5px;' : 'margin: 0;'" class="allhaveping">{{msgdata.gbnum}}人团</span>{{msgdata.headfree
              ...
              <div class="gpbox">
                    ...
                    <div class="items xiabox" :style="allping.length>=4?'width:80%;flex-wrap:wrap':''">
                        ...
                        <div class="canyu" v-for="(item,index) in allping" :key='index'>
                           <img  v-if="msgdata.groupbuylist[index]" :src="msgdata.groupbuylist[index].head?msgdata.groupbuylist[index].head:(msgdata.groupbuylist[index].head===''?'./img/man.jpg':'./img/hui.png')"/>
