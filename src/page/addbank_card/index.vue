    ...
    <section v-cloak v-if="status==2">
      ...
      <div class="itemboxs">
        <div class="item">
          ...
          <div class="inputhide">
            <input type="tel" name maxlength="19" value v-model="banknumber" ref="content">
          </div>
        </div>
      </div>
      <div class="itemboxs">
  ...
  methods: {
    next: function() {
      ...
      if (this.status == 0) {
        ...
        https({
          url: siteUrl + "Main/MemberPay/VerifiedUser?uid=" + getname(),
          data: {
            uid: getname(),
        ...
        https({
          url: siteUrl + "Main/MemberPay/BindUserBank?uid=" + getname(),
          method: "post",
          data: {
            uid: getname(),
    ...
    getyaoqingma() {
      ...
      if (that.status == 1) {
        https({
          url:
            siteUrl + "Main/MemberPay/UnBindUserBankAdvance?uid=" + getname(),
          method: "post",
          data: {
            uid: getname(),
        ...
        https({
          url: siteUrl + "Main/MemberPay/BindUserBankAdvance?uid=" + getname(),
          method: "post",
          data: {
            uid: getname(),
            bankid: that.renbankid,
    ...
    deletcare: function(bankid) {
      ...
      alerts("提示", "是否解除绑定", "解除", function() {
        https({
          url: siteUrl + "Main/MemberPay/UnBindUserBank",
          method: "post",
          data: {
            uid: getname(),
            bankid: bankid
    ...
    datalist: function() {
      var that = this;
      https({
        url: siteUrl + "Main/MemberPay/GetUserBankListJson",
        method: "get",
        data: {
          uid: getname()
        },
