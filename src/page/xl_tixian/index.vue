<template>
  <div id="app" v-cloak>
    ...
    <div class="awbox">
      ...
      <div class="po3">提现金额需要先转入到提现账号,<span @click="gozhuang">去转账</span></div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getMsg: function() {
      ...
      showLoading();
      https({
        url: siteUrl + "Main/MemberPay/GetBalance",
        data: {
          uid: getname()
        },
        headers: 1,
    ...
    tixian: function() {
      ...
      https({
        url:siteUrl + "Main/MemberPay/Withdrawal?uid=" + getname() + "&devicetype=1",
        method: "post",
        headers: 1,
        data: {
          uid: getname(),
